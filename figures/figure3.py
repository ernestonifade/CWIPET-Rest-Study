  ...
  if results_input is None or isinstance(
    ...
    if isinstance(results_input, list):
      ...
      file_candidates = [
          ...
          "../results/enrichment_results_for_correlating_cytokines.xlsx",
      ]
  ...
  if selected_view == "🧬 Pathway Enrichment: Correlating Metabolites":
    ...
    if prot_path and os.path.exists(prot_path):
      ...
      render_searchable_table(
          ...
          columns_to_show=[ #Pathway name	#Entities total	Expected_Hits	#Entities found	Raw p	Holm p	Entities FDR	Enrichment_Ratio	Log2_Enrichment_Ratio
